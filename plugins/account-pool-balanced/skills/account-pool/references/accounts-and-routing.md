Enable Account Pool Balanced and keep the builtin Account Pooler disabled.
Add Claude or Codex credentials, then inspect proxy routes and account quota:

```sh
bb plugin enable account-pool-balanced
